<footer class="footer bg-cPrimary color-cText p-4 justify-center text-center grid sm:grid-cols-3 grid-cols-1 mt-10">
    <div class="order-2 sm:order-1 sm:text-xl text-2xl my-5">
    ...
    <div class="flex justify-center items-center order-1 sm:order-2 my-5"> 
        <a href="{{ route('index') }}">
            <x-application-logo class="block h-9 w-auto fill-current color-cPrimary">w-32</x-application-logo>
        </a>
    </div>
    <div class="border-3 order-3 sm:text-xl text-2xl my-5">
