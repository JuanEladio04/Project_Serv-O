<x-guest-layout>
    <h1 class="my-10 text-6xl text-center">
        Terminos y condiciones
    </h1>

    <section id="politicaDeCookies" class="my-10 bg-cPrimary w-full block px-5 sm:px-10 py-10">
        <h2 class="text-center text-5xl my-5">
            Política de cookies
        </h2>
        ...
        <h3 class="text-center text-3xl my-5">
            Cookies propias
        </h3>
        <p class="text-justify">
            Son aquellas cookies que son enviadas al ordenador o dispositivo del Usuario y gestionadas
            exclusivamente por Serv-Ω para el mejor funcionamiento del Sitio Web. La información que se recaba se
            emplea para mejorar la calidad del Sitio Web y su Contenido y su experiencia como Usuario. Estas cookies
    ...
    <section id="politicaDePrivacidad" class="my-10 bg-cPrimary w-full block px-5 sm:px-10 py-10">
        <h2 class="text-center text-5xl my-5">
            POLÍTICA DE PRIVACIDAD DEL
            SITIO WEB
        </h2>
        ...
        <p class="text-justify">
            Respetando lo establecido en la legislación vigente, Serv-Ω (en adelante, también Sitio Web) se
        ...
        <h4 class="text-center text-3xl my-5">
        ...
        <ul class="list-disc pl-20 my-5">
            <li>El Reglamento (UE) 2016/679 del Parlamento Europeo y del Consejo, de 27 de abril de 2016, relativo
            ...
            <li>El Real Decreto 1720/2007, de 21 de diciembre, por el que se aprueba el Reglamento de desarrollo
        ...
        <p class="text-justify">
            El responsable del tratamiento de los datos personales recogidos en Serv-Ω es: Juan Eladio Pareja Martín,
            con NIF: 25609703P (en adelante, Responsable del tratamiento). Sus datos de contacto son los siguientes:
        </p>
        <ul class="list-disc pl-20 my-5">
            <li>Dirección: C. Juego de Pelota, 54, 14900 Lucena, Córdoba</li>
            <li>Teléfono de contacto: 333333333</li>
            <li>Email de contacto: jparmar01@iesmarquesdecomares.org</li>
        </ul>
        <h4 class="text-center text-3xl my-5">
        ...
        <p class="text-justify">
            ...
            recabados por Serv-Ω, mediante los formularios extendidos en sus páginas quedarán incorporados y serán
            tratados en nuestro fichero con el fin de poder facilitar, agilizar y cumplir los compromisos establecidos
            entre Serv-Ω y el Usuario o el mantenimiento de la relación que se establezca en los formularios que este
            ...
            mantiene un registro de actividades de tratamiento que especifica, según sus finalidades, las actividades
            de tratamiento llevadas a cabo y las demás circunstancias establecidas en el RGPD
        </p>
        <h4 class="text-center text-3xl my-5">
        ...
        <p class="text-justify">
            Las categorías de datos que se tratan en Serv-Ω son únicamente datos identificativos. En ningún caso, se
        ...
        <p class="text-justify">
            La base legal para el tratamiento de los datos personales es el consentimiento. Serv-Ω se compromete a
        ...
        <p class="text-justify">
            Los datos personales son recabados y gestionados por Serv-Ω con la finalidad de poder facilitar, agilizar y
            ...
            estadística, y actividades propias del objeto social de Serv-Ω, así como para la extracción, almacenamiento
            de datos y estudios de marketing para adecuar el Contenido ofertado al Usuario, así como mejorar la
        ...
        <p class="text-justify">
            ...
            tratamiento y, en todo caso, únicamente durante el siguiente plazo: Hasta el borrado de la cuenta, o hasta
        ...
        <p class="text-justify">
            <span class="block">Los datos personales del Usuario no serán compartidos con terceros.</span>
        ...
        <p class="text-justify">
            ...
            podrán otorgar su consentimiento para el tratamiento de sus datos personales de forma lícita por Serv-Ω.
        ...
        <p class="text-justify">
            Serv-Ω se compromete a adoptar las medidas técnicas y organizativas necesarias, según el nivel de
            seguridad adecuado al riesgo de los datos recogidos, de forma que se garantice la seguridad de los datos
            de carácter personal y se evite la destrucción, pérdida o alteración accidental o ilícita de datos
            personales
            transmitidos, conservados o tratados de otra forma, o la comunicación o acceso no autorizados a dichos
            datos.
            Sin embargo, debido a que Serv-Ω no puede garantizar la inexpugnabilidad de internet ni la ausencia total
            de hackers u otros que accedan de modo fraudulento a los datos personales, el Responsable del
        ...
        <p class="text-justify">
            El Usuario tiene sobre Serv-Ω y podrá, por tanto, ejercer frente al Responsable del tratamiento los
            siguientes derechos reconocidos en el RGPD y la Ley Orgánica 3/2018, de 5 de diciembre, de Protección de
            Datos Personales y garantía de los derechos digitales:
        </p>
        <ul class="list-disc pl-20 my-5">
            <li>
                Derecho de acceso: Es el derecho del Usuario a obtener confirmación de si Serv-Ω está tratando o
                no sus datos personales y, en caso afirmativo, obtener información sobre sus datos concretos de
                carácter personal y del tratamiento que Serv-Ω haya realizado o realice, así como, entre otra, de la
            ...
            <li>
                ...
                de carácter personal o se cese el tratamiento de los mismos por parte de Serv-Ω.
            </li>
            <li>
        ...
        <p class="text-justify">
            ...
            del tratamiento con la referencia \"RGPD-www.serv-o.es\", especificando:
        </p>
        <ul class="list-disc pl-20 my-5">
            <li>
        ...
        <p class="text-justify">Esta solicitud y todo otro documento adjunto podrá enviarse a la siguiente dirección y/o
            correo electrónico:</p>
        <p class="text-justify">Dirección postal: C. Juego de Pelota, 54, 14900 Lucena, Córdoba</p>
        <p class="text-justify">Correo electrónico: jparmar01@iesmarquesdecomares.org</p>
        <h4 class="text-center text-3xl my-5">
            Enlaces a sitios web de terceros
        </h4>
        <p>
            El Sitio Web puede incluir hipervínculos o enlaces que permiten acceder a páginas web de terceros
            distintos de Serv-Ω, y que por tanto no son operados por Serv-Ω. Los titulares de dichos sitios web
        ...
        <h3 class="text-center text-3xl my-5">
            ACEPTACIÓN Y CAMBIOS EN ESTA POLÍTICA DE
            PRIVACIDAD
        </h3>
        <p class="text-justify">
        ...
        <p class="text-justify">
            Serv-Ω se reserva el derecho a modificar su Política de Privacidad, de acuerdo a su propio criterio, o
